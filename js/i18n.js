...
const TRANSLATIONS = {
  en: {
    ...
    'absence.endDateOptional': 'Same as start',
    'absence.endDateHint': 'Leave End date blank to report just one day, or pick a later date to cover a whole range — even across months.',
    'absence.endBeforeStart': 'End date can’t be before the start date.',
    ...
    'absence.confirmSubmitRange': 'Report yourself unavailable from {start} to {end}? Your departments and church leadership will be notified.',
  ...
  fr: {
    ...
    'absence.date': 'Date',
    'absence.startDate': 'Date de début',
    'absence.endDate': 'Date de fin',
    'absence.endDateOptional': 'Identique à la date de début',
    'absence.endDateHint': 'Laissez la date de fin vide pour signaler un seul jour, ou choisissez une date ultérieure pour couvrir toute une période — même sur plusieurs mois.',
    'absence.endBeforeStart': 'La date de fin ne peut pas être avant la date de début.',
    ...
    'absence.confirmSubmitRange': 'Vous signaler absent(e) du {start} au {end} ? Vos départements et la direction de l’église seront informés.',
