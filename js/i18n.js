...
const TRANSLATIONS = {
  en: {
    ...
    'users.removedBadge': 'Removed',
    'users.removeFromChurch': 'Remove from Church',
    'users.confirmRemoveChurchTitle': 'Remove from the church?',
    'users.confirmRemoveChurch': '{name} will be removed from every department and blocked from signing in. This can be undone with "Reinstate". Continue?',
  ...
  fr: {
    ...
    'users.removedBadge': 'Retiré',
    'users.removeFromChurch': "Retirer de l'église",
    'users.confirmRemoveChurchTitle': "Retirer cette personne de l'église ?",
    'users.confirmRemoveChurch': '{name} sera retiré(e) de tous les départements et ne pourra plus se connecter. Cette action peut être annulée avec « Réintégrer ». Continuer ?',
